...
import 'package:hd_wallet/app/presantation/controllers/auth_controller.dart';
import 'package:hd_wallet/app/presantation/pages/login/widgets/enter_phone_number_widget.dart';
import 'package:hd_wallet/app/presantation/pages/login/widgets/phone_verfication_widget.dart';
...
import 'package:hd_wallet/app/presantation/utils/state_status.dart';
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
              ...
              onPressed: () => Get.toNamed(AppRoutes.settingPage),
            )
          ],
        ),
        body: Padding(
